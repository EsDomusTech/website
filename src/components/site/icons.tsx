...
export function IconBlueprint({ className, size }: IconProps) {
  return (
...
export function IconInterior({ className, size }: IconProps) {
  return (
    <svg {...base(size)} className={className} aria-hidden>
...
export function IconUrban({ className, size }: IconProps) {
  return (
    <svg {...base(size)} className={className} aria-hidden>
...
export function IconPlanning({ className, size }: IconProps) {
  return (
    <svg {...base(size)} className={className} aria-hidden>
...
export function IconModel3d({ className, size }: IconProps) {
  return (
    <svg {...base(size)} className={className} aria-hidden>
...
export function IconDecor({ className, size }: IconProps) {
  return (
    <svg {...base(size)} className={className} aria-hidden>
...
export function IconCompass({ className, size }: IconProps) {
  return (
    <svg {...base(size)} className={className} aria-hidden>
...
export function IconArch({ className, size }: IconProps) {
  return (
    <svg {...base(size)} className={className} aria-hidden>
...
export function IconColumns({ className, size }: IconProps) {
  return (
    <svg {...base(size)} className={className} aria-hidden>
