...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Casas modulares modernas e sustentáveis no Porto e Norte de Portugal, com arquitetura contemporânea, eficiência energética e construção rápida e precisa." },
      ...
      { property: "og:description", content: "Casas modulares modernas e sustentáveis no Porto e Norte de Portugal, com arquitetura contemporânea, eficiência energética e construção rápida e precisa." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: SITE.domain },
      { property: "og:site_name", content: SITE.name },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "EsDomusTech - Casas Modulares" },
      { name: "twitter:description", content: "Casas modulares modernas e sustentáveis no Porto e Norte de Portugal, com arquitetura contemporânea, eficiência energética e construção rápida e precisa." },
