...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Desenvolvemos casas modernas, sustentáveis e totalmente personalizadas, combinando arquitetura contemporânea, eficiência energética e tecnologia que garante pre" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "DomusTech - Casas Modulares" },
      { property: "og:description", content: "Desenvolvemos casas modernas, sustentáveis e totalmente personalizadas, combinando arquitetura contemporânea, eficiência energética e tecnologia que garante pre" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;0,700;1,400&family=Lato:wght@300;400;700&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
