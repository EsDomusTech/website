...
export const Route = createFileRoute("/politica-de-privacidade")({
  head: () => ({
    meta: [
      { title: "Política de Privacidade | EsDomusTech" },
      {
        name: "description",
        content:
          "Política de Privacidade da EsDomusTech: como recolhemos, utilizamos e protegemos os seus dados pessoais.",
      },
      { property: "og:title", content: "Política de Privacidade | EsDomusTech" },
  ...
  return (
    <main>
      <PageHeader
        ...
        image="https://images.unsplash.com/photo-1521737711867-e3b97375f902?w=1600&h=900&fit=crop&auto=format&q=80"
      />
