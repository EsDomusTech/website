...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    excerpt: "Resumo do artigo 1 — a preencher antes do lançamento.",
    body: [
      "Conteúdo do artigo 1 em preparação.",
    ],
  },
  {
    slug: "artigo-2",
    ...
    excerpt: "Resumo do artigo 2 — a preencher antes do lançamento.",
    body: [
      "Conteúdo do artigo 2 em preparação.",
    ],
  },
  {
    slug: "artigo-3",
    ...
    excerpt: "Resumo do artigo 3 — a preencher antes do lançamento.",
    body: [
      "Conteúdo do artigo 3 em preparação.",
    ],
  },
];
