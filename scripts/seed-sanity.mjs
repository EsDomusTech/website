/**
 * Seed script — populates Sanity from existing site-data.ts content.
 * Run once: node scripts/seed-sanity.mjs
 * Requires SANITY_TOKEN env var (write token from sanity.io/manage).
 */
...
const SERVICES = [
  {
    _type: "service",
    slug: { _type: "slug", current: "casas-modulares-porto" },
    name: "Casas Modulares no Porto",
    titleFirst: "CASAS",
    titleSecond: "MODULARES",
    metaTitle: "Casas Modulares Porto | Construção Modular | EsDomusTech",
    metaDescription: "Casas modulares no Porto: rápidas, sustentáveis e totalmente personalizadas. Projeto, fabrico e montagem chave na mão pela EsDomusTech.",
    excerpt: "Casas modulares pré-fabricadas, entregues chave na mão, com eficiência energética e prazos de construção reduzidos.",
    intro: [
  ...
  {
    _type: "service",
    slug: { _type: "slug", current: "construcao-modular" },
    name: "Construção Modular",
    titleFirst: "CONSTRUÇÃO",
    titleSecond: "MODULAR",
    metaTitle: "Construção Modular Porto | Edifícios e Habitação | EsDomusTech",
    metaDescription: "Construção modular para habitação, comércio e espaços corporativos no Porto. Soluções pré-fabricadas escaláveis, sustentáveis e de montagem rápida.",
    excerpt: "Soluções de construção modular escaláveis para habitação, comércio e espaços corporativos, com montagem rápida e limpa.",
    intro: [
    ...
    process: [
      { _key: "01", num: "01", title: "Análise de Requisitos", text: "Estudo da escala do projeto, uso pretendido (habitacional, comercial ou corporativo) e requisitos técnicos e regulamentares." },
      { _key: "02", num: "02", title: "Engenharia e Sistemas", text: "Cálculo estrutural, dimensionamento de especialidades (AVAC, elétrica, redes) e integração de domótica e energias renováveis." },
      { _key: "03", num: "03", title: "Pré-fabricação", text: "Módulos produzidos em fábrica com controlo de qualidade rigoroso — rastreabilidade total de materiais e inspecção final antes do envio." },
      { _key: "04", num: "04", title: "Montagem no Local", text: "Instalação com mínima perturbação do entorno, baixa produção de resíduos e cronograma cumprido — entregamos o que prometemos." },
    ],
  },
];
...
const PROJECTS = [
  { _type: "project", slug: { _type: "slug", current: "villa-atlantico" }, name: "Villa Atlântico", category: "Residencial", location: "Foz do Douro, Porto", year: "2025", image: "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=1200&h=800&fit=crop&auto=format&q=80", summary: "Moradia modular de três pisos com vista para o mar e eficiência energética classe A.", description: ["A Villa Atlântico é uma moradia modular contemporânea desenhada para tirar o máximo partido da luz natural e das vistas sobre o Atlântico.", "Os módulos pré-fabricados permitiram uma construção rápida e limpa, integrando soluções de energia renovável e domótica de ponta."] },
  { _type: "project", slug: { _type: "slug", current: "edificio-ribeira" }, name: "Edifício Ribeira", category: "Comercial", location: "Ribeira, Porto", year: "2024", image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=1200&h=800&fit=crop&auto=format&q=80", summary: "Reabilitação modular de um edifício histórico para uso comercial e escritórios.", description: ["Um projeto de reabilitação que preserva a fachada histórica enquanto introduz interiores modulares modernos e flexíveis.", "O resultado combina o carácter da Ribeira com espaços de trabalho eficientes e sustentáveis."] },
  { _type: "project", slug: { _type: "slug", current: "loft-boavista" }, name: "Loft Boavista", category: "Interiores", location: "Boavista, Porto", year: "2025", image: "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=1200&h=800&fit=crop&auto=format&q=80", summary: "Projeto de interiores de um loft urbano com linhas minimalistas e materiais naturais.", description: ["O Loft Boavista é um exercício de design de interiores minimalista, onde cada elemento foi escolhido a dedo.", "Materiais naturais, iluminação cuidada e mobiliário à medida criam um ambiente sereno e sofisticado."] },
  { _type: "project", slug: { _type: "slug", current: "praca-central" }, name: "Praça Central", category: "Urbanismo", location: "Matosinhos, Porto", year: "2023", image: "https://images.unsplash.com/photo-1524230572899-a752b3835840?w=1200&h=800&fit=crop&auto=format&q=80", summary: "Requalificação de um espaço público com soluções modulares e mobiliário urbano.", description: ["A requalificação da Praça Central devolveu à comunidade um espaço público moderno e funcional.", "Estruturas modulares, zonas verdes e mobiliário urbano sustentável definem este projeto de urbanismo."] },
  { _type: "project", slug: { _type: "slug", current: "cotton-house" }, name: "Cotton House", category: "Interiores", location: "Bonfim, Porto", year: "2024", image: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=1200&h=800&fit=crop&auto=format&q=80", summary: "Renovação de apartamento histórico com interiores têxteis e materialidade artesanal.", description: ["O Cotton House é uma ode à textura e ao artesanato. Um apartamento do século XIX foi completamente renovado, preservando os azulejos originais e introduzindo interiores têxteis de luxo.", "Cada divisão conta uma história de contrastes: o antigo e o contemporâneo, o rugoso e o suave, o branco e o ouro."] },
  { _type: "project", slug: { _type: "slug", current: "armada-center" }, name: "Armada Center", category: "Comercial", location: "Cedofeita, Porto", year: "2024", image: "https://images.unsplash.com/photo-1461088945293-0c17689e48ac?w=1200&h=800&fit=crop&auto=format&q=80", summary: "Edifício de escritórios com fachada modular e espaços de trabalho flexíveis.", description: ["O Armada Center é um edifício de escritórios premium desenhado para atrair empresas de tecnologia e criativas. A fachada modular ventilada permite personalização e eficiência energética máxima.", "Os espaços interiores foram concebidos com flexibilidade total: open spaces, salas de reunião modulares e terraços jardim definem este espaço de trabalho do futuro."] },
  { _type: "project", slug: { _type: "slug", current: "solar-douro" }, name: "Solar do Douro", category: "Residencial", location: "Peso da Régua", year: "2023", image: "https://images.unsplash.com/photo-1486325212027-8081e485255e?w=1200&h=800&fit=crop&auto=format&q=80", summary: "Quinta de turismo rural com módulos de hospedagem integrados na paisagem.", description: ["O Solar do Douro é um projeto de enoturismo onde seis módulos de hospedagem foram inseridos na encosta vinhateira sem alterar a topografia.", "Cada módulo tem vistas panorâmicas para o rio Douro e integra sistemas de energia solar e recolha de água da chuva."] },
];
...
const BLOG_POSTS = [
  {
    _type: "blogPost",
    slug: { _type: "slug", current: "licenciamento-casas-modulares-portugal" },
  ...
  {
    _type: "blogPost",
    slug: { _type: "slug", current: "quanto-custa-casa-modular" },
  ...
  {
    _type: "blogPost",
    slug: { _type: "slug", current: "casa-modular-vs-construcao-tradicional" },
  ...
  {
    _type: "blogPost",
    slug: { _type: "slug", current: "processo-construcao-modular" },
...
const FAQS = [
  { _type: "faq", q: "Uma casa modular é tão sólida como uma tradicional?", a: "Sim. Usamos os mesmos materiais de acabamento da construção tradicional, e a estrutura em aço galvanizado (espessura mínima 3 mm, durabilidade estimada de 50 anos) oferece segurança adicional e melhor isolamento térmico e acústico." },
  { _type: "faq", q: "Quanto tempo demora a construção?", a: "Entre 12 e 18 meses após a emissão da licença de construção, com o licenciamento camarário a demorar tipicamente entre 2 a 4 meses." },
  { _type: "faq", q: "O que está incluído no preço?", a: "Uma lista alargada que cobre desde a visita técnica e o projeto de arquitetura até à entrega chave na mão: estrutura, casas de banho completas, isolamento, pavimentos, janelas e portas, eletricidade e canalizações, cobertura, transporte, garantia estrutural de 10 anos e acompanhamento de licenciamento." },
  { _type: "faq", q: "A casa pode ser ampliada no futuro?", a: "Sim. A construção modular permite uma abordagem evolutiva ao longo do tempo, ajustando a casa às necessidades futuras da família." },
  { _type: "faq", q: "Que classe energética tem?", a: "Classe A." },
  { _type: "faq", q: "Preciso de contratar um arquitecto?", a: "Não. O projeto de arquitetura e engenharia, com imagens 3D, está incluído no nosso serviço chave na mão." },
...
const TEAM = [
  { _type: "teamMember", name: "Raquel Figueiredo", role: "Gestora de Obras", image: "/images/equipa/raquel.webp" },
  { _type: "teamMember", name: "Marisa Xavier", role: "Administrativo de Obras e Compras", image: "/images/equipa/mariza.webp" },
  { _type: "teamMember", name: "Juliane Zombini", role: "Responsável Administrativo", image: "/images/equipa/julliana.webp" },
  { _type: "teamMember", name: "Marina Dias", role: "Assistente Administrativo e de RH", image: "/images/equipa/marina.webp" },
];
...
async function seed() {
  ...
  const all = [...SERVICES, ...PROJECTS, ...BLOG_POSTS, ...FAQS, ...TEAM];
